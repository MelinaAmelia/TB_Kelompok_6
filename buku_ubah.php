            ...
            <div class="col-md-12">
                <form method="post">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $query = mysqli_query($koneksi, "UPDATE buku SET id_kategori='$kategori', judul='$judul', penulis='$penulis', penerbit='$penerbit', tahun_terbit='$tahun_terbit', deskripsi='$deskripsi' WHERE id_buku=$id");
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <a href="?page=kategori_buku" class="btn btn-danger">Kembali</a>
                        </div>
                    </div>
                </form>
            </div>
