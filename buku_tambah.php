                ...
                <form method="post">
                    <?php
                        if (isset($_POST['submit'])) {
                            ...
                            $query = mysqli_query($koneksi, "INSERT INTO buku (id_kategori, judul, penulis, penerbit, tahun_terbit, deskripsi) VALUES ('$kategori', '$judul', '$penulis', '$penerbit', '$tahun_terbit', '$deskripsi')");
